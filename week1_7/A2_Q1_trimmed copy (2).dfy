...
method ComputeCount(CountIndex:nat, a:seq<int>,b:array<int>) returns (p:nat)
    ...
    ensures p == Count(CountIndex,old(a)) && CountIndex != 0 ==> forall i:: 1<= i <= CountIndex ==> b[i - 1] == Count(i,old(a[..])) 
{
    if CountIndex == 0{
        p :=0;
    } else{
...
method PreCompute(a:array<int>,b:array<int>)
    ...
    modifies b
    ensures  b.Length != 0 ==> forall i:: 1<=i<=b.Length ==> b[i-1] == Count(i,old(a[..]))
{ 
...
method Evens1(a:array<int>,b:array<int>) returns (c:array2<int>)
